...
type MetadataStore interface {
	...
	AddKey(ctx context.Context, username string, keyID, keyHash, name, description string, userGroups []string, subscription string, tenant string, expiresAt *time.Time, ephemeral bool) error
