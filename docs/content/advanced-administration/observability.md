...
| **Latency** (P50/P95/P99 per subscription) | Met | `istio_request_duration_milliseconds_bucket` with `subscription` label via Istio Telemetry + `X-MaaS-Subscription` header. |
