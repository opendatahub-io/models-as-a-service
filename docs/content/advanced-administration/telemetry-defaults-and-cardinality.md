...
|--------|------|--------|---------|
| `authorized_hits` | Counter | `user`, `subscription`, `model`, `organization_id`, `cost_center`, `limitador_namespace` | Token consumption (from `usage.total_tokens` in response body) |
| `authorized_calls` | Counter | `user`, `subscription`, `organization_id`, `cost_center`, `limitador_namespace` | Requests allowed through rate limiting |
| `limited_calls` | Counter | `user`, `subscription`, `organization_id`, `cost_center`, `limitador_namespace` | Requests denied by rate limits |
