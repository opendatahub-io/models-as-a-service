...
- `AITenant.spec.rbac` has been removed. The controller still creates tenant-admin Roles, but platform administrators must create standard Kubernetes RoleBindings to grant access. See [Tenant RBAC](../configuration-and-management/tenant-rbac.md).
