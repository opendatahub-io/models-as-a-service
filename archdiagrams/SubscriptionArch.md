...
| Concern | Handled By | Examples |
| :---: | :---: | :---: |
| Commercial Limits | MaaSSubscription | Rate limits, quotas, rates, cost caps |
...
Defines who (OIDC subjects/groups/userid) can access a specific **Model**. 
...
Defines a subscription plan with **per-model token rate limits** and quotas, as well as extra token information.
...
Keys are minted at the **subscription level**, making access explicit.
...
| :---- | :---- | :---- |
| **MaaSAuthPolicy** | AuthPolicy (for MaaS API) | Controls who can request keys for a subscription; embeds token metadata in token |
