...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AIGatewayTLS) DeepCopyInto(out *AIGatewayTLS) {
	*out = *in
	out.CertificateRef = in.CertificateRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AIGatewayTLS.
func (in *AIGatewayTLS) DeepCopy() *AIGatewayTLS {
	if in == nil {
		return nil
	}
	out := new(AIGatewayTLS)
