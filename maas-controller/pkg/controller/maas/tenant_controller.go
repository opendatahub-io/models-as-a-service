...
func (r *TenantReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	if authExists {
		...
		ctrl.Log.Info("Authentication CRD not yet registered; watch will be added dynamically when OpenShift API is ready")
	}
	...
	if dsciExists {
		...
		ctrl.Log.Info("DSCInitialization CRD not yet registered; watch will be added dynamically when ODH is ready")
	}
