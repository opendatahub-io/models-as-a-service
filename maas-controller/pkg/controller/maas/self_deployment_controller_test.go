...
func TestLifecycleReconciler_TeardownOptimizedCleanupAllAITenantsInSinglePass(t *testing.T) {
	...
	aitenant0 := lifecycleTestUnstructured(
		schema.GroupVersionKind{Group: "maas.opendatahub.io", Version: "v1alpha1", Kind: "AITenant"},
		tenantreconcile.DefaultAITenantNamespace,
		"aitenant-0",
		aitenantFinalizer,
	)
	aitenant1 := lifecycleTestUnstructured(
		schema.GroupVersionKind{Group: "maas.opendatahub.io", Version: "v1alpha1", Kind: "AITenant"},
		tenantreconcile.DefaultAITenantNamespace,
		"aitenant-1",
		aitenantFinalizer,
	)
	aitenant2 := lifecycleTestUnstructured(
		schema.GroupVersionKind{Group: "maas.opendatahub.io", Version: "v1alpha1", Kind: "AITenant"},
		tenantreconcile.DefaultAITenantNamespace,
		"aitenant-2",
		aitenantFinalizer,
	...
	cl := fake.NewClientBuilder().WithScheme(s).
		...
		WithRuntimeObjects(dep, aitenant0, aitenant1, aitenant2).
		Build()
	r := &LifecycleReconciler{
		Client:            cl,
		Scheme:            s,
