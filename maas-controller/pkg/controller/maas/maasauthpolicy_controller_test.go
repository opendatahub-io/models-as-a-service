...
func TestBuildGatewayAuthPolicySpec_K8sAndOIDCAuth(t *testing.T) {
	...
	t.Run("without OIDC", func(t *testing.T) {
		spec := r.buildGatewayAuthPolicySpec("{}", nil, map[string]modelSubjectAllowlist{})
	...
	t.Run("with OIDC", func(t *testing.T) {
		...
		spec := r.buildGatewayAuthPolicySpec("{}", oidc, map[string]modelSubjectAllowlist{})
		obj := gwSpecToUnstructured(t, spec)
...
func TestBuildGatewayAuthPolicySpec_PublicPaths(t *testing.T) {
	...
	t.Run("without public paths no anonymous auth rule", func(t *testing.T) {
		...
		spec := r.buildGatewayAuthPolicySpec("{}", nil, allowlists)
		obj := gwSpecToUnstructured(t, spec)
