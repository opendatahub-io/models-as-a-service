...
echo -e "${MAGENTA}3. Testing API Keys (Legacy SA-backed, POST /v1/api-keys, list/get via /v1/api-keys)...${NC}"
...
echo -e "${BLUE}ℹ Note: Single API key deletion now available at DELETE /v1/api-keys/:id${NC}"
