...
echo "   - See examples/keycloak/test-realms/ (when available)"
echo "   - ⚠️  Test realms contain hardcoded passwords - NOT for production"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "⚠️  Production Recommendations:"
echo "  - Configure external PostgreSQL database for Keycloak"
echo "  - Enable TLS/HTTPS (disable HTTP)"
echo "  - Increase instances for high availability"
echo "  - Set up monitoring and backup procedures"
echo "  - Secure admin credentials in a secret manager"
echo ""
echo "For MaaS OIDC integration documentation, see:"
echo "  docs/external-oidc-integration.md (when available)"
echo ""
